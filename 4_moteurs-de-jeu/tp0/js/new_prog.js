...
class myImg {
    ...
    this.img = new Image();
    this.img.src = "./assets/mouse.png";

    /*
    this.img.onload = function() {
        this.ctx.drawImage(this.img, this.posXStart, this.posYStart, this.w, this.h)
    }
    */
    }
...
*/
mouseFolder.add(img, "x", 0, 600, 1);
mouseFolder.add(img, "y", 0, 400, 1);
